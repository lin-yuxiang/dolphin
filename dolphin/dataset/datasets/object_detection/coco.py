...
from dolphin.dataset.evaluate import eval_recalls
...
class CocoDataset(BaseDataset):
    ...
    def __init__(self,
        ...
        if self.data_prefix is not None:
            ...
            if not (self.img_prefix is None or osp.isabs(self.img_prefix)):
                self.img_prefix = osp.join(self.data_prefix, self.img_prefix)
            if not (self.proposal_file is None or osp.isabs(
                self.proposal_file)):
                self.proposal_file = osp.join(
                    self.data_prefix, self.proposal_file)
    ...
    def prepare_train_img(self, idx):
        ...
        results['filename'] = copy.deepcopy(img_info['filename'])
        results['gt_bbox'] = copy.deepcopy(ann_info['bboxes'])
        results['label'] = copy.deepcopy(ann_info['labels'])
        results['gt_bbox_ignore'] = copy.deepcopy(ann_info['bboxes_ignore'])
