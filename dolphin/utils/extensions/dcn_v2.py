...
from dolphin import ext as _backend
    ...
    def backward(ctx, grad_output):
        ...
        grad_input, grad_offset, grad_mask, grad_weight, grad_bias = \
            _backend.dcn_v2_backward(
                ...
                ctx.stride[1], ctx.padding[0], ctx.padding[1], ctx.dilation[0], 
...
class DCNv2(nn.Module):
    ...
    def forward(self, input, offset, mask):
        ...
        assert (self.deformable_groups * self.kernel_size[0] * 
                self.kernel_size[1]) == mask.shape[1]
        return dcn_v2_conv(
...
class DCN(DCNv2):
    ...
    def __init__(self, in_channels, out_channels,
        ...
        self.conv_offset_mask = nn.Conv2d(
            self.in_channels, channels_, kernel_size=self.kernel_size,
